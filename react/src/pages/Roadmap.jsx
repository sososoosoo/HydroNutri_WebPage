...
const crops = [
  ...
  },
  {
    ...
    description: 'Ginseng saponins are among the most studied phytochemicals in East Asian medicine, with robust evidence supporting immune modulation, anti-fatigue, and adaptogenic applications. Precision cultivation enables consistent ginsenoside profiles unachievable with field-grown root.',
  ...
  },
  {
    ...
    description: 'Lemna is one of the fastest-growing aquatic plants on earth, capable of doubling its biomass in under 48 hours. Its protein density rivals that of soybean at a fraction of the land footprint, positioning it as a leading candidate for next-generation vegan food ingredients.',
